...
GRAY = "#7d8590"
TOTAL = "#e6edf3"
# HEATMAP_THEME=light -> GitHub's light-mode ramp, for a <picture> light variant
if os.environ.get("HEATMAP_THEME") == "light":
    COLORS = ["#ebedf0", "#9be9a8", "#40c463", "#30a14e", "#216e39"]
    GRAY, TOTAL = "#59636e", "#1f2328"
...
<style>
  ...
  text.total {{ fill:{TOTAL}; font-size:15px; font-weight:700; }}
